    ...
    client.on('guildMemberRemove', async member => {
        ...
        if(userBan != null){
            let log = new Discord.RichEmbed()
                ...
                .setDescription(userBan.toString() + " a banni " + member.toString() + " du serveur")
            ...
            let log = new Discord.RichEmbed()
                ...
                .setDescription(userKick.toString() + " a expulsé " + member.toString() + " du serveur")
            ...
            let log = new Discord.RichEmbed()
                .setColor(16711680)
                .setAuthor(member.user.username, member.user.avatarURL)
                .setDescription(member.toString() + " à quitté le discord")
                .addField("Date d\'arrivée", moment(member.joinedAt).format('DD/MM/YYYY HH:mm:ss'),true)
                .addField("ID", member.user.id, true)
                .setTimestamp(new Date());
            member.guild.channels.find((channel) => channel.name === "logs").send(log);
    ...
    client.on('messageDelete', async function(message) {
        ...
        if(user === message.author){
            let log = new Discord.RichEmbed()
                ...
                .setDescription(user.toString() + " a supprimé son message")
